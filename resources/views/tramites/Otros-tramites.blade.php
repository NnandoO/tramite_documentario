...
<body>
    ...
    <div class="textotipotramite">OTROS TRAMITES</div>

    <div class="textodetalles">
    <div class="seccion-titulo">Detalles :</div>
    <div class="seccion-item">• Duración : 10 días</div>
    ...
    <div class="seccion-item">• RECIBO</div>
    <div class="seccion-item">• SOLICITUD</div>
    <div class="seccion-item">• ANEXOS</div>
    <br>
    <br>
    ...
    <div class="textoreq1">RECIBO</div>
    <div class="textoreq2">SOLICITUD</div>
    <div class="textoreq3">ANEXOS</div>
...
<a href="{{ url('/') }}" class="flecha-atras">←</a>
    ...
    <form action="{{ route('tramites.otros') }}" method="POST" enctype="multipart/form-data">
    @csrf
