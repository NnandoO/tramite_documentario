...
<body>
    ...
    <div class="textotipotramite">CAMBIO DE TITULO DEL PLAN DE TESIS</div>

    <div class="textodetalles">
    <div class="seccion-titulo">Detalles :</div>
    <div class="seccion-item">• Duración : 5 días</div>
    ...
    <form action="{{ route('tramites.cambio') }}" method="POST" enctype="multipart/form-data">
    @csrf
